...
@testset "bezier surfaces Building" begin
    ...
    @testset "Bezier surface using open uniform knot vectors" begin
        @test typeof(bezsurf(5, 5, arr, 5, 5)) == Tuple{Array{Float64,2}, Array{Array{Int64,1},1}, Array{Array{Int64,1},1}}
        @test isapprox(bezsurf(5, 5, arr, 5, 5)[1], P; atol = 1e-3)
        @test bezsurf(5, 5, arr, 5, 5)[2] == EV
        @test bezsurf(5, 5, arr, 5, 5)[3] == FV
    end
end
